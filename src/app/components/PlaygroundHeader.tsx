...
const PlaygroundHeader = () => {
  ...
  return (
    <header className={isSticky ? 'sticky-apiheader' : 'api-header'} id='playground-header'>
      <div id='api-header-logo'>
        <img src="/picknpin_logo.png" alt="" />
      </div>
      <div className='header-items'>
        <div id='playground-navbar-items' className='navbar'>
          <a  href='/#home'>Home</a>
          <div
          ...
          >
            ...
            {isProductsDropdownOpen && (
              <div className="products-dropdown-content" id="sticky-products-dropdown">
                <div>
          ...
          >
            ...
            {isDeveloperDropdownOpen && (
              <div className="api-dropdown-content"  id='sticky-api-dropdown'>
